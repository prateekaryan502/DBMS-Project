...
<h2 class="text-center"> Thank you for using Foodie! The ordering process is now complete.</h2>
...
<h4>Your delivery rider details:<br>

<?php
$q="SELECT D_ID,D_NAME,CONTACT FROM delivery WHERE status=1 and D_ID=(select min(D_ID) from delivery)";
...
{
echo $row["D_NAME"].'  '.$row["CONTACT"];
}
$q2="update delivery set status=0 where D_NAME like '".$row["D_NAME"]."';";
$res2=mysqli_query($conn,$q2);
}
else
{echo 'no delivery executive available';
}
?>
