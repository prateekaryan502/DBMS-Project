...
<div class="jumbotron">
  <div class="container text-center">
    <h1>Hey Foodie!</h1>      
    <p>Choose the delicacies from our famous restaurants</p>
  </div>
</div>
...
<h5 class="text-info">Quantity: <input type="number" name="quantity" class="form-control" value="1" style="width: 60px;"> </h5>
